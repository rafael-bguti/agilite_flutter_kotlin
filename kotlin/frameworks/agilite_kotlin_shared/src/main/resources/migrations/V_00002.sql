...
UPDATE gdf10 SET gdf10uidtrack = ' ' WHERE gdf10uidtrack IS NULL;
ALTER TABLE gdf10 ALTER COLUMN gdf10uidtrack SET NOT NULL;

ALTER TABLE gdf10 ADD COLUMN IF NOT EXISTS gdf10dados JSONB ;
UPDATE gdf10 SET gdf10dados = '{}' WHERE gdf10dados IS NULL;
ALTER TABLE gdf10 ALTER COLUMN gdf10dados SET NOT NULL;
...
ALTER TABLE srf01 ADD COLUMN IF NOT EXISTS srf01emitirdoc BOOLEAN ;
UPDATE srf01 SET srf01emitirdoc = false WHERE srf01emitirdoc IS NULL;
ALTER TABLE srf01 ALTER COLUMN srf01emitirdoc SET NOT NULL;
...
ALTER TABLE srf01 ADD COLUMN IF NOT EXISTS srf01integrascf SMALLINT  DEFAULT 0 ;
UPDATE srf01 SET srf01integrascf = 0 WHERE srf01integrascf IS NULL;
ALTER TABLE srf01 ALTER COLUMN srf01integrascf SET NOT NULL;

ALTER TABLE srf01 ADD COLUMN IF NOT EXISTS srf01numeronfse INTEGER ;

DROP INDEX IF EXISTS srf01_uk;
CREATE UNIQUE INDEX srf01_uk ON srf01 (srf01empresa);
DROP INDEX IF EXISTS srf01_mk;
CREATE INDEX srf01_mk ON srf01 (srf01empresa);
