...
CREATE TABLE IF NOT EXISTS gdf20 (gdf20id SERIAL NOT NULL, CONSTRAINT gdf20pk PRIMARY KEY(gdf20id));
...
ALTER TABLE cgs18 ADD COLUMN IF NOT EXISTS cgs18nome VARCHAR(30) ;
...
CREATE UNIQUE INDEX cgs18_uk ON cgs18 (cgs18empresa, cgs18nome);
DROP INDEX IF EXISTS cgs18_mk;
CREATE INDEX cgs18_mk ON cgs18 (cgs18empresa, cgs18nome);
...
ALTER TABLE gdf10 ADD COLUMN IF NOT EXISTS gdf10nfsenumero INTEGER ;
...
ALTER TABLE gdf20 ADD COLUMN IF NOT EXISTS gdf20empresa BIGINT ;
UPDATE gdf20 SET gdf20empresa = 0 WHERE gdf20empresa IS NULL;
ALTER TABLE gdf20 ALTER COLUMN gdf20empresa SET NOT NULL;

ALTER TABLE gdf20 ADD COLUMN IF NOT EXISTS gdf20numero BIGINT ;
UPDATE gdf20 SET gdf20numero = 0 WHERE gdf20numero IS NULL;
ALTER TABLE gdf20 ALTER COLUMN gdf20numero SET NOT NULL;

ALTER TABLE gdf20 ADD COLUMN IF NOT EXISTS gdf20dtenvio DATE ;
UPDATE gdf20 SET gdf20dtenvio = '2000-01-01' WHERE gdf20dtenvio IS NULL;
ALTER TABLE gdf20 ALTER COLUMN gdf20dtenvio SET NOT NULL;

DROP INDEX IF EXISTS gdf20_uk;
CREATE UNIQUE INDEX gdf20_uk ON gdf20 (gdf20empresa, gdf20numero);
DROP INDEX IF EXISTS gdf20_mk;
CREATE INDEX gdf20_mk ON gdf20 (gdf20empresa, gdf20numero);
...
ALTER TABLE scf021 ADD COLUMN IF NOT EXISTS scf021remnumero INTEGER ;
UPDATE scf021 SET scf021remnumero = 0 WHERE scf021remnumero IS NULL;
...
ALTER TABLE scf021 ADD COLUMN IF NOT EXISTS scf021retdata DATE ;
UPDATE scf021 SET scf021retdata = '2000-01-01' WHERE scf021retdata IS NULL;
ALTER TABLE scf021 ALTER COLUMN scf021retdata SET NOT NULL;

ALTER TABLE scf021 ADD COLUMN IF NOT EXISTS scf021dtpgto DATE ;
...
ALTER TABLE srf01 ADD COLUMN IF NOT EXISTS srf01lotenfse BIGINT ;
...
DO $$ BEGIN BEGIN  ALTER TABLE srf01 ADD CONSTRAINT srf01lotenfse_gdf20_FK FOREIGN KEY (srf01lotenfse) REFERENCES gdf20 (gdf20id) ON DELETE SET NULL ;  EXCEPTION WHEN duplicate_object THEN RAISE NOTICE 'Constraint already exists, command ignored';  END; END $$;
