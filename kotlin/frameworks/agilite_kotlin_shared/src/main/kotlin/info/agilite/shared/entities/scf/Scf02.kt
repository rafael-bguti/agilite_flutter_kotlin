...
val SCF02FORMA = FieldMetadata("scf02forma", 3, "Forma", FieldTypeMetadata.fk, 10.0, true, "Cgs38", null, null, null, null, true, true, false, null);
val SCF02ENTIDADE = FieldMetadata("scf02entidade", 4, "Entidade", FieldTypeMetadata.fk, 10.0, true, "Cgs80", null, null, null, null, true, true, false, null);
val SCF02NOSSONUM = FieldMetadata("scf02nossoNum", 5, "Nosso Número", FieldTypeMetadata.long, 12.0, false, null, null, null, null, null, true, true, false, null);
...
val SCF02DTVENC = FieldMetadata("scf02dtVenc", 8, "Data de vencimento", FieldTypeMetadata.date, 10.0, true, null, null, null, null, null, true, true, false, null);
...
val SCF02VALOR = FieldMetadata("scf02valor", 10, "Valor", FieldTypeMetadata.decimal, 16.2, true, null, null, null, null, null, true, true, false, null);
