...
const val N_CGS80EMPRESA = "cgs80empresa";
const val N_CGS80NOME = "cgs80nome";
const val N_CGS80FANTASIA = "cgs80fantasia";
const val N_CGS80CODIGO = "cgs80codigo";
const val N_CGS80TIPO = "cgs80tipo";
const val N_CGS80NI = "cgs80ni";
const val N_CGS80CONTRIBUINTE = "cgs80contribuinte";
const val N_CGS80IE = "cgs80ie";
const val N_CGS80IM = "cgs80im";
const val N_CGS80CEP = "cgs80cep";
const val N_CGS80ENDERECO = "cgs80endereco";
const val N_CGS80BAIRRO = "cgs80bairro";
const val N_CGS80NUMERO = "cgs80numero";
const val N_CGS80COMPLEMENTO = "cgs80complemento";
const val N_CGS80UF = "cgs80uf";
const val N_CGS80MUNICIPIO = "cgs80municipio";
const val N_CGS80TELEFONE = "cgs80telefone";
const val N_CGS80CELULAR = "cgs80celular";
const val N_CGS80EMAIL = "cgs80email";
const val N_CGS80OBS = "cgs80obs";
const val N_CGS80CLIENTE = "cgs80cliente";
const val N_CGS80FORNECEDOR = "cgs80fornecedor";
const val N_CGS80TRANSPORTADORA = "cgs80transportadora";
